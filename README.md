...
References
Text Preprocessing: YouTube Link

Introduction to Latent Semantic Analysis: YouTube Link

GeeksforGeeks, N-gram Language Modelling with NLTK: Article Link

Machine Learning Geek, Latent Semantic Indexing Using Scikit-Learn: Article Link

Claude (AI Assistant): Suggestions on evaluation metrics and code snippets for the project.
